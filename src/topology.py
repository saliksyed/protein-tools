...
class Residue:
	...
	def add_child(self, child):
		...
		atom_from = self.atoms[self.child_atom_idx]

		# find all bonds referencing the child_atom_idx
		#bonds = filter(lambda x : x.get_atom_1() == atom_from or x.get_atom_2() == atom_from, self.get_bonds())
